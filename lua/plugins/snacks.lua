...
return {
    ...
    dashboard = {
      ...
      preset = {
        ...
        keys = {
          ...
          { icon = "󰒲 ", key = "p", desc = "Pack List", action = ":PackList" },
          { icon = "󰚰 ", key = "u", desc = "Pack Upgrade", action = ":PackUpgrade" },
  ...
  keys = {
    ...
    { "<leader>sp", function() Snacks.picker.files({ cwd = vim.fn.stdpath("config") .. "/lua/plugins" }) end, desc = "Search Plugin Specs", },
    ...
    { "<leader>tt", function() Snacks.terminal(nil, { win = { position = "float", width = 0, height = 0, border = "none" } }) end, desc = "Terminal Fullscreen" },
